...
const
  // Clean JSON literal. Delphi strings use single quotes, so double quotes inside require no escaping.
  // Any single quote inside the JSON content is doubled (e.g., Belt''s).
  S: string =
'{'#13#10+
'  "nodes": ['#13#10+
