...
uses
  ...
  FMX.ListView.Types,
  FMX.Effects, FMX.Filter.Effects, FMX.Media, FMX.Styles,
...
begin
  ...
  StylePath := System.IOUtils.TPath.Combine(System.IOUtils.TPath.GetDocumentsPath, 'Assets/Styles/SolarStyle.style');
...
procedure TFrmMain.ExtractAudioFromResources;
  ...
  begin
    try
      ...
      try
        Tmp := System.IOUtils.TPath.Combine(System.IOUtils.TPath.GetTempPath, OutName);
      ...
      var Base := System.IOUtils.TPath.Combine(System.IOUtils.TPath.GetDocumentsPath, 'Assets');
      var ClickPath := System.IOUtils.TPath.Combine(Base, System.IOUtils.TPath.Combine('Sounds','click.mp3'));
      var AchPath   := System.IOUtils.TPath.Combine(Base, System.IOUtils.TPath.Combine('Sounds','achievement.mp3'));
